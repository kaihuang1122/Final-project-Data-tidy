...
#/Users/kaihuang1122/Documents/ML/Final/html.2023.final.data/release/20231002/500101001.json
#os.mkdir("1124tidy")
...
day11 = ["%02d"% x for x in range(1,24)]
day11 = [["11", x] for x in day11]
mid = "/"
target = list(target)
suffix = ".json"

my_prifix = "/Users/kaihuang1122/Documents/ML/Final/Data tidy/1124version"
for port in target:
    ...
    for day in day10+day11:
        ...
        mdw = day[0]+','+day[1]+','+week_convert(int(day[0]), int(day[1]))+','
