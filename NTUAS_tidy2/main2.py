...
MNIN = open("/Users/kaihuang1122/Documents/ML/Final/Data tidy/NTUAS_tidy2/Total/MN.csv")
MN = list(csv.reader(MNIN))
MNR2IN = open("/Users/kaihuang1122/Documents/ML/Final/Data tidy/NTUAS_tidy2/Total/MNR2.csv")
MNR2 = list(csv.reader(MNR2IN))
counting = 0
table = []
epoch = (datetime(2023, 11, 28, 0, 0, 0))

fout = open("/Users/kaihuang1122/Documents/ML/Final/Data tidy/NTUAS_tidy2/Total/data.csv", "w")
writter = csv.writer(fout)

while epoch.timestamp() <= datetime(2023, 12, 5, 0, 0, 0).timestamp():
