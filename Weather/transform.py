...
fin = open("/Users/kaihuang1122/Documents/ML/Final/Data tidy/Weather/1_minute_insert.csv")
...
print(table)
fout = open("/Users/kaihuang1122/Documents/ML/Final/Data tidy/Weather/predict2.csv", "w")
